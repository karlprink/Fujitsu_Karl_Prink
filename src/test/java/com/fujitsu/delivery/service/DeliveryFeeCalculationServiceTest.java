...
class DeliveryFeeCalculationServiceTest {
    ...
    void calculateDeliveryFee_carInTallinn_returnsOnlyBaseFee() {
        ...
        verify(weatherDataRepository, never()).findFirstByStationNameOrderByObservationTimestampDesc(anyString());
    }
    ...
    void calculateDeliveryFee_bikeInTartu_withExampleCalculations() {
        ...
        when(weatherDataRepository.findFirstByStationNameOrderByObservationTimestampDesc("Tartu-Tõravere"))
    ...
    void calculateDeliveryFee_scooterInParnu_withRainAndCold() {
        ...
        DeliveryFeeDTO response = deliveryFeeCalculationService.calculateDeliveryFee("Pärnu", "Scooter");
