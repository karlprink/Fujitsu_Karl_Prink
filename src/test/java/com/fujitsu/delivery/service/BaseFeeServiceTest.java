...
/**
 * Unit tests for the BaseFeeService.
 * This class verifies the core business logic for managing base fee rules,
 * including retrieval, creation with duplicate validation, updates, and deletion.
 */
...
class BaseFeeServiceTest {
    ...
    /**
     * Tests that getAllBaseFees retrieves all records from the repository.
     * Verifies that the repository's findAll method is invoked exactly once.
     */
    @Test
    ...
    /**
     * Tests the successful creation of a new base fee rule.
     * Verifies that the service checks for existing duplicates and saves the new rule if none are found.
     */
    @Test
    ...
    /**
     * Tests that creating a base fee fails if a rule for the same city and vehicle type already exists.
     * Verifies that an IllegalArgumentException is thrown and the save method is never called.
     */
    @Test
    void createBaseFee_duplicateFee_throwsIllegalArgumentException() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> baseFeeService.createBaseFee(duplicateFee));
    ...
    /**
     * Tests the update logic for an existing base fee rule.
     * Verifies that fields are correctly mapped from the request to the existing entity before saving.
     */
    @Test
    ...
    /**
     * Tests updating a base fee rule that does not exist.
     * Verifies that an empty Optional is returned and no save operation is attempted.
     */
    @Test
    ...
    /**
     * Tests the successful deletion of a base fee rule by its ID.
     * Verifies that the service checks for existence before calling the delete method.
     */
    @Test
    ...
    /**
     * Tests deleting a base fee rule that does not exist.
     * Verifies that the service returns false and does not attempt a delete operation.
     */
    @Test
