...
/**
 * Configuration class for OpenAPI (Swagger) documentation. Sets up the API metadata such as title,
    ...
    return new OpenAPI()
        .info(
            new Info()
                ...
                .version("1.0.0")
                .description(
                    "REST API for calculating delivery fees based on dynamic regional rules, vehicle types, and real-time weather conditions.")
                .contact(new Contact().name("Karl Prink").email("karlprink58@gmail.com")));
  }
}
