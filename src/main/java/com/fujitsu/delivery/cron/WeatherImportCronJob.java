...
/**
 * Orchestrator for weather data import events.
 * Handles both scheduled periodic updates and application startup checks.
 */
@Component
...
public class WeatherImportCronJob {
    ...
    /**
     * Periodically triggers the weather data import based on the cron expression
    ...
    /**
     * Triggers a check and potential data import immediately after the
